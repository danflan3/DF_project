...
For the final project, I using a simulated data set from the PUSH trial - a randomized clinical trial of children with HIV in Kenya. The dataset includes observations (rows) for `r nrow(push_data)` children with HIV who were hospitalized for concurrent illness and evaluated for TB disease. The dataset includes variables for clinical, radiographic, diagnostic tests, and biomarker data for each participant.
